    ...
    <div class="side-info">
        ...
        <div class="side-info-content">
            ...
            <div class="contact-infos mb-30">
                ...
                <div class="contact-list mb-30">
                    <h4>Email Address</h4>
                    <p><a href="https://themepure.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="dcb5b2bab39cb9a4bdb1acb0b9f2bfb3b1">[email&#160;protected]</a></p>
                    <p><a href="https://themepure.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e7829f868a978b82c98a868e8ba78f928ac984888a">[email&#160;protected]</a></p>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/3.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/3-2.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div> -->
                                        ...
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/11.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/11-2.jpg" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div>
                                            ...
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        ...
                                                        <img class="product-secondary" src="img/product/10-2.jpg" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div>
                                        ...
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/cat1.png" alt="product_image">
                                                        <img class="product-secondary" src="img/product/cat2.png" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div>
                                    ...
                                    <div class="swiper-wrapper">
                                                ...
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product__action">
                                                        <div class="inner__action">
                                                            ...
                                                            <div class="view">
                                                                <a href="javascript:void(0)avascript:void(0)"><i class="fal fa-eye"></i></a>
                                                            </div>
                                                            <div class="layer">
                                                                <a href="#"><i class="fal fa-layer-group"></i></a>
                                                            </div>
                                        ...
                                        <div class="product-item swiper-slide">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/cat2.png" alt="product_image">
                                                        <img class="product-secondary" src="img/product/cat1.png" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                    ...
                                                    <div class="product-info mb-10">
                                                       ...
                                                       <div class="product__name">
                                                        <h4><a href="shop.html">Synthetic Flat Sandal for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="product-item swiper-slide">
                                            <div class="product">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/cat3.png" alt="product_image">
                                                        <img class="product-secondary" src="img/product/cat2.png" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">new</a>
                    ...
                    <div class="testimonial mb-100">
                        <div class="testimonial__item text-center">
                            ...
                            <div class="testimonial__content">
                                <p class="mb-25">Great theme, extended super and fast professional support. Easy to use, flexible, visual composer and more functional<br> plugins on board. Yes a real good, strong theme with structured coding.<br>
    ...
    <div class="container-fluid">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="section-wrapper text-center mb-35 ">
                    ...
                    <p class="text-white">Commodo sociosqu venenatis cras dolor sagittis integer luctus sem primis<br> eget maecenas sed urna malesuada.</p>
                </div>
            </div>
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                            <div class="product product_3">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/8.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/8-2.jpg" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div>
                                        ...
                                        <div class="product-item swiper-slide wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                                            <div class="product product_3">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/7.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/7-2.jpg" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div>
                                                    ...
                                                    <div class="product__action">
                                                        <div class="inner__action">
                                                            <div class="wishlist">
                                                             ...
                                                             <div class="view">
                                                            <a href="javasjavascript:void(0)ript:void(0)"><i class="fal fa-eye"></i></a>
                                                        </div>
                                                            <div class="layer">
                                                                <a href="#"><i class="fal fa-layer-group"></i></a>
                                                            </div>
...
<div class="subscribe__area pb-100 pt-50" data-background="img/blog/flowershape.png">
    <div class="container">
        <div class="section-wrapper text-center mb-35">
            ...
            <p>Sign up for all the news about our latest arrivals and get an exclusive early access shopping. Join 60.000+ Subscribers<br> 
