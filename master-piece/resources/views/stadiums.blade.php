    ...
    <div class="side-info">
        ...
        <div class="side-info-content">
            ...
            <div class="contact-infos mb-30">
                ...
                <div class="contact-list mb-30">
                    <h4>Email Address</h4>
                    <p><a href="https://themepure.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ff96919990bf9a879e928f939ad19c9092">[email&#160;protected]</a></p>
                    <p><a href="https://themepure.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4f2a372e223f232a61222e26230f273a22612c2022">[email&#160;protected]</a></p>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/17.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/17-2.jpg" alt="product_image">
                                                    </a>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/26.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/26-2.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">new</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Black Flower 126</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/2.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/2-1.jpg" alt="product_image">
                                                    </a>
                                                    <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div>
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Croft Flat Sandal for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/12.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/12-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Fly Synthetic Sandal for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/10.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/10-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Flat Sandal for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/31.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/31-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">edges Shoes For Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/1.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/1-2.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Sandal for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Fly Sandal For Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/5.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/5-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/14.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/14-2.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Sandals for Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/17.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/17-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/21.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/21-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Fashionable Sandals For Women</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/22.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/22-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Hollow Sandals Cross</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Womens fashionable </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    <a href="single.html">
                                                        <img class="product-primary" src="img/product/24.jpg" alt="product_image">
                                                        <img class="product-secondary" src="img/product/24-1.jpg" alt="product_image">
                                                    </a>
                                                    <!-- <div class="product__update">
                                                        <a class="#">sale</a>
                                                    </div> -->
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">New Style Men Casual</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">High Quality Korean Fashion </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">sneaker for men new 2021 </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">New fashion Sport Men</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Casual Shoes 2021 Men New </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Fashionable Men sneaker 2021 </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Men's Running Shoes Rubber </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Casual Shoes Made In China</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html"> Men Casual Footwear Blue </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Walkar Mens Sports Shoe</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Shoes CB 00451</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-4">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Sneaker Shoes In Bangladesh</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">White Sneakers shoe for </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Casual Shoes - White and Black</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">men shoes trend mens air </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Flyknit Sneaker for Men</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html"> Fashionable Ash Sneakers</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Converse for Men Classy Style</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">breathable sports round toe men </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Classic Sneakers Shoes for Men</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html"> Classic Men Sneakers </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">Sneakers Casual Shoes</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html">exclusive Sneakers for Men</a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html"> design Men Sneakers </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="product product-3">
                                                <div class="product__thumb">
                                                    ...
                                                    <div class="product-info mb-10">
                                                        ...
                                                        <div class="product__name">
                                                        <h4><a href="single.html"> brand Men Sneakers </a></h4>
                                                        <div class="pro-price">
                                                            <p class="p-absoulute pr-1"><span>$</span>680.00 - <span>$</span>680.00</p>
                                                            <a class="p-absoulute pr-2" href="#">add to cart</a>
                                                        </div>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="list-product">
                                                    <div class="list__thumb">
                                                        <a href="single.html"><img src="img/product/5.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="list__content">
                                                    <div class="viewcontent">
                                                        <div class="viewcontent__header">
                                                            <a href="single.html"><h2 class="mb-10">especially for Carl Hansen</h2></a>
                                                        </div>
                                    ...
                                    <div class="border-top">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="list-product">
                                                    <div class="list__thumb">
                                                        <a href="single.html"><img src="img/product/10.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-8 col-lg-8 col-md-8">
                                                <div class="list__content">
                                                    <div class="viewcontent">
                                                        <div class="viewcontent__header">
                                                            <a href="single.html"><h2 class="mb-10"> the first models created</h2>
</a>                                                               </div>
                                                        <div class="viewcontent__rating">
                                                            <i class="fal fa-star ratingcolor"></i>
                                                            <i class="fal fa-star ratingcolor"></i>
                                    ...
                                    <div class="border-top">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="list-product">
                                                    <div class="list__thumb">
                                                        <a href="single.html"><img src="img/product/23.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-8 col-lg-8 col-md-8">
                                                <div class="list__content">
                                                    <div class="viewcontent">
                                                        <div class="viewcontent__header">
                                                            <a href="single.html"><h2 class="mb-10">Brown Leather Bags</h2></a>
                                                        </div>
                                                        <div class="viewcontent__rating">
                                                            <i class="fal fa-star ratingcolor"></i>
                                                            <i class="fal fa-star ratingcolor"></i>
                                    ...
                                    <div class="border-top">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="list-product">
                                                    <div class="list__thumb">
                                                        <a href="single.html"><img src="img/product/9.jpg" alt=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-8 col-lg-8 col-md-8">
                                                <div class="list__content">
                                                    <div class="viewcontent">
                                                        <div class="viewcontent__header">
                                                            <a href="single.html"><h2 class="mb-10">Faxon Canvas Low</h2></a>
                                                        </div>
                                                        <div class="viewcontent__rating">
                                                            <i class="fal fa-star ratingcolor"></i>
                                                            <i class="fal fa-star ratingcolor"></i>
