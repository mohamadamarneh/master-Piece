...
@section('name')
    <div class="container mt-5">
        <h2 class="mt-5">edit <b>{{ $info->name }}</b> Couache </h2>
        <hr>
        <form action="{{ route('update-coache') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $info->phone }}" class="form-control" name="phone" id=""
