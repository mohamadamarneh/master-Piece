...
@section('name')
    <div class="container mt-5">
        ...
        @endif
        <h2>Users</h2>
        <form action="add-coustumer" method="POST">
            @csrf
                ...
                @foreach ($list as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="edit-coustumer/{{ $item->id }}" class="btn btn-secondry btn-sx">edit</a>

                            <form action="delete-coustumer" method="POST" style="display: inline">
                                @csrf
